...
def main():
    ...
    for epoch in range(cfg.process.train_epochs):
        ...
        for n_iter, ((imgs, audio, mask, flow),
            ...
            model.train()
            output, mask_feature = model(audio, imgs, flow)  # [bs*5, 1, 224, 224]
            ...
            loss, loss_dict = IouSemanticAwareLoss(
                output, mask_feature, mask.unsqueeze(1).unsqueeze(1), frames=frame, **cfg.loss)
        ...
        with torch.no_grad():
            for n_iter, batch_data in enumerate(val_dataloader):
                ...
                imgs, audio, mask, flows, _, _ = batch_data
